    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li>
                    <a href="categories.php"><i class="fa fa-fw fa-dashboard"></i> Категории</a>
                </li>
                <li>
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <input type="submit" name="submit" class="btn btn-primary" value="Добавить категорию">
                        </div>
                    </form>
                </div>
                <div class="col-sm-6">
